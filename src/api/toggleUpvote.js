...
export const useToggleUpvoteMutation = () => {
	...
	return useMutation({
		mutationFn: (variables) => toggleUpvote(variables.userId, variables.resourceId),
...
const toggleUpvote = async (userId, resourceId) => {
	...
	await updateDoc(resourceRef, { upvotes: resource.upvotes, upvotes_count: resource.upvotes_count });
}
